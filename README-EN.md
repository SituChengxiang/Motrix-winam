...
Build for Windows On ARM (WoA) comes from a 12-grade student's winter vacation social paractice 😂
...
It is install Motrix using the installer package (Motrix-Setup-x.y.z.exe) , other ways do not have Arm build.  
(Welcome to add!)
